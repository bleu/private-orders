...
contract PrivateTradeOrder is IConditionalOrderGenerator {
    ...
    function _requireOrderHash(bytes32 _hash, bytes32 domainSeparator, GPv2Order.Data calldata order)
        private
        pure
    {
        ...
        returns (GPv2Order.Data memory)
    {
        return role == PrivateTradeRole.Maker
            ...
            : PrivateTradeLib.takerOrder(terms);
    }
}
